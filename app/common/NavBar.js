  ...
  return (
    <div id="nav" className="h-12 relative shadow-custom">
      ...
      >
        {!show ? (
          <>
            <a className={`self-center ${colStyle === "grid" ? "active-svg" : "currentColor"}`} onClick={(e) => handleColStyle(e)}>
              <svg
                viewBox="0 0 21 21"
            ...
            <a className={`self-center ${colStyle === "list" ? "active-svg" : "currentColor"}`} onClick={(e) => handleColStyle(e)}>
              <svg
                viewBox="0 0 21 21"
                xmlns="http://www.w3.org/2000/svg"
                height={21}
